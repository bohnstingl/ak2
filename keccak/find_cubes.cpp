...
/*int main()
{
  ...
  uint cube_vars3[] = { 128, 130, 131, 139, 145, 146, 147, 148, 151, 155, 158,
      160, 161, 163, 164, 165, 185, 186, 189, 190, 193, 196, 205, 212, 220, 225,
      229, 238, 242, 245, 249 };
  //cube.keccak_rounds_ = 1;
  cube.addArray(cube_vars1, 1);
